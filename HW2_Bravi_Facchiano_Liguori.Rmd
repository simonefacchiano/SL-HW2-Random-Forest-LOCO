...
hist(rowMeans(train[, -c(1:4)]), 
     breaks = 10, xlab = 'Mean', border = F, col = 'steelblue',
     prob = T, main = 'Row Means')
...
We therefore import the dataset, reduce the dimensionality by exracting the quartiles and the maximum and minimum for each time series and fit the model.
